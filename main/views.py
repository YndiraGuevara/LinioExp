...
class HomePageView(TemplateView):
  ...
  def get_context_data(self, **kwargs):
    ...
    context['latest_products'] = Producto.objects.all()[:5] #los 5 primeros
...
class DetallePeListView(ListView):
  model=DetallePedido

class DetallePeDetailView(DetailView):
  model=DetallePedido
...
class CompletePaymentView(View):
    #para confirmar el pago y agradecerle
