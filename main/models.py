...
class Producto(models.Model):
    ...
    comerciante = models.ForeignKey('Comerciante', on_delete=models.SET_NULL, null=True)
...
class Pedido(models.Model):
    ...
    #si un cliente elimna su cuenta, todos sus pedidos se eliminan
    ...
    #auto_now: que se ponga la hora de hoy automaticamente
    fecha_entrega = models.DateTimeField(blank=True, null=True)
    #blank: se puede crear un pedido que no sabemos cuando entregar
    estado = models.CharField(max_length=3)
    ...
    RUC_Factura = models.CharField(max_length=11, default="-")
    def __str__(self):
        return f'{self.cliente} - {self.fecha_creacion} - {self.estado}'

    def get_total(self):
        """Obtiene el monto total del pedido en base a los totales de detalle"""
